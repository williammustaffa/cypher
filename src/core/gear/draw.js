...
export default function draw() {
  ...
  /*draw every instance*/
  instances.map( function(instance, value) {
      GI.context.save();
      GI.context.translate(instance.x + instance.xOffset, instance.y+instance.yOffset);
      GI.context.rotate(instance.image_angle * Math.PI / 180);
      GI.context.scale(instance.xscale, instance.yscale);
      GI.context.translate(-instance.x, -instance.y);
      GI.context.fillStyle = instance.color;
      GI.context.strokeStyle = instance.color;
  ...
  /* draw each viewport */
  GI.current_room.viewports.map( function(obj, ind) {
    var view = obj;
    var index = ind;
